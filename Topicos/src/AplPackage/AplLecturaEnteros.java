...
import Unidad2.*;
public class AplLecturaEnteros extends JFrame implements ActionListener {

    JLeeEntero txtEdad, txtEstatura, txtPeso;
    JButton btnGrabar, btnLimpiar;

    public AplLecturaEnteros() {
    ...
    private void Valida(ActionEvent e) {
        if (e.getSource() == txtEdad) {
            ...
            if (valor < 18 || valor > 60) {
                AplExamenU2.Rutinas.Mensaje("Rango no válido de edades");
                return;
            }
        ...
        if (e.getSource() == txtEstatura) {
            ...
            if (valor < 170 || valor > 200) {
                AplExamenU2.Rutinas.Mensaje("Rango no válido de estatura, válido(170-200)");
                return;
            }
        ...
        if (e.getSource() == txtPeso) {
            ...
            if (valor < 70 || valor > 100) {
                AplExamenU2.Rutinas.Mensaje("Rango no válido de peso, válido(70-100)");
                return;
            }
